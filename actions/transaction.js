...
export async function createTransaction(data) {
  try {
    ...
    // Combine user and account queries for better performance
...
function convertToISODateTime(dateString) {
  try {
    ...
    // If the date string doesn't include time (like "2008-03-02"), 
    // the Date constructor will set time to 00:00:00 UTC
